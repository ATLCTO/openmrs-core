...
public class HibernateSessionFactoryBean extends LocalSessionFactoryBean {
	...
	public void afterPropertiesSet() throws IOException {
		...
		if ("none".equals(strategy)) {
			...
			config.putIfAbsent("hibernate.tenant_identifier_resolver", "org.openmrs.api.db.hibernate.MultiTenantIdentifierResolver");
			config.putIfAbsent("hibernate.multi_tenant_connection_provider", "org.openmrs.api.db.hibernate.MultiTenantSchemaConnectionProvider");
		}
